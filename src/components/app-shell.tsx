...
export async function AppShell({ children, workspaceName, role }: { children: React.ReactNode; workspaceName: string; role: string }) {
  ...
  return <div className="app-frame">
    <aside className="sidebar">
      ...
      <div className="sidebar-foot"><div className="workspace-chip"><span>{workspaceName.slice(0,1).toUpperCase()}</span><div><strong>{workspaceName}</strong><small>{role}</small></div></div></div>
    </aside>
